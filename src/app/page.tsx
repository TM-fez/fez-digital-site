        ...
        <div className="relative z-10 text-center space-y-10 max-w-5xl mx-auto px-6 py-12">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative inline-flex items-center gap-3 px-8 py-4 border-2 border-border/80 hover:border-primary rounded-xl font-semibold text-lg transition-all duration-500 backdrop-blur-xl bg-background/60 hover:bg-accent shadow-lg overflow-hidden cursor-pointer"
            >
